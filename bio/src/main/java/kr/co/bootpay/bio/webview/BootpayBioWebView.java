...
//        Log.d("bootpay", "requestPasswordForPay");
    ...
    void requestScript() {
        Log.d("bootpay", "requestType11: " + CurrentBioRequest.getInstance().requestType);
...
//        this.is
    ...
    private class BootpayJavascriptBridge implements JSBioInterfaceBridge {
        ...
        public void error(String data) {
            if(CurrentBioRequest.getInstance().webviewEventListner != null) {
                CurrentBioRequest.getInstance().webviewEventListner.onWebViewError(data);
            }
...
//            }
        ...
        public void close(String data) {
            if(CurrentBioRequest.getInstance().webviewEventListner != null) {
                CurrentBioRequest.getInstance().webviewEventListner.onWebViewClose(data);
            }
//            stopProgressDialog();
...
//            }
        ...
        public void cancel(String data) {
            if(CurrentBioRequest.getInstance().webviewEventListner != null) {
                CurrentBioRequest.getInstance().webviewEventListner.onWebViewCancel(data);
            }
...
//            if(CurrentBioRequest.getInstance().listener != null) CurrentBioRequest.getInstance().listener.onCancel(data);
        ...
        public void issued(String data) {
            if(CurrentBioRequest.getInstance().webviewEventListner != null) {
                CurrentBioRequest.getInstance().webviewEventListner.onWebViewIssued(data);
            }
...
//        }
        ...
        public void confirm(String data) {
            if(CurrentBioRequest.getInstance().webviewEventListner != null) {
                CurrentBioRequest.getInstance().webviewEventListner.onWebViewConfirm(data);
            }
...
//            return String.valueOf(goTransaction);
        ...
        public void done(String data) {
            if(CurrentBioRequest.getInstance().webviewEventListner != null) {
                CurrentBioRequest.getInstance().webviewEventListner.onWebViewDone(data);
            }
//            stopProgressDialog();
...
//            if(CurrentBioRequest.getInstance().listener != null) CurrentBioRequest.getInstance().listener.onDone(data);
        ...
        public void redirectEvent(String data) {
            if(CurrentBioRequest.getInstance().webviewEventListner != null) {
                CurrentBioRequest.getInstance().webviewEventListner.onWebViewRedirect(data);
            }
...
//        }
        ...
        public void easyError(String data) {
            ...
            if(CurrentBioRequest.getInstance().webviewEventListner != null) {
                CurrentBioRequest.getInstance().webviewEventListner.onWebViewEasyError(data);
            }
...
//                    job.initToken = true;
//                    job.nextType = BioConstants.REQUEST_PASSWORD_FOR_PAY;
//                    if(CurrentBioRequest.getInstance().webviewEventListner != null) CurrentBioRequest.getInstance().webviewEventListner.onNextJob(job);
//                    return;
//                }
...
//            }
        ...
        public void easySuccess(String data) {
            ...
            if(CurrentBioRequest.getInstance().webviewEventListner != null) {
                CurrentBioRequest.getInstance().webviewEventListner.onWebViewEasySuccess(data);
            }
