...
public class BootpayBioWebViewChromeClient extends WebChromeClient {
    protected Context mContext;

    public BootpayBioWebViewChromeClient(Context context) {
    ...
    public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
        ...
        BootpayBioWebView webview = (BootpayBioWebView) view;
//        newWindow.setEventListener(webview.mEventListener);
